...
describe('DAOVesting', function () {
    ...
    before(async function () {
        ...
        const Vesting = await ethers.getContractFactory('DAOVesting');
    ...
    it('should revert initialize when vesting token balance is lower than desired', async function () {
        await superproToken.transfer(vesting.address, parseEther(189_999_999));
